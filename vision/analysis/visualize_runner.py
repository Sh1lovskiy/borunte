...
from vision.io.series import load_series
from vision.processing.depth import depth_to_cloud
from vision.viz.viewer import Viewer
...
def run_visualize(paths: Sequence[Path | str] | Path | str, *, config: VisionConfig | None = None) -> None:
